...
public:
    ...
    friend void operator++(Integer &obj , int);     //Постфиксная форма, дружественная функция, увеличивает на 2
    friend void operator--(Integer &obj , int);     //Постфиксная форма, дружественная функция, уменьшает на 2
